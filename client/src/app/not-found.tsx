      ...
      <div className="w-full max-w-2xl p-8 mx-4 bg-white rounded-lg shadow-lg">
        <article className="text-center">
          ...
          <h2 className="text-[#0257AC] text-3xl font-bold mb-4">
            Oops! Medical Term Not Found
          </h2>
          <p className="text-[#0257AC] text-lg mb-8">
            It seems you've searched for a term that's not in our MediGlossary database yet. 
            Don't worry, medical knowledge is always expanding, and so are we. Let's get you 
            back to the main page where you can look up other medical terms or suggest this one for addition.
          </p>
          <Button
